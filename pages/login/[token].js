...
function TokenLogin() {
	...
	useEffect(() => {
		...
		async function logUserIn() {
			...
			userStore.setToken(responseToken)
		}
		...
		<div>
			...
			<main className="flex items-center justify-center min-h-screen max-h-full bg-primary-100">
				<div className="flex flex-col items-center justify-center bg-secondary-200 py-12 px-16 shadow-md rounded-xl">
					<img className="h-24 w-auto" src="/steve-avatar.png"></img>
					<div className="flex flex-col items-center mt-8">
						<svg className="animate-spin h-10 text-primary-100" viewBox="0 0 24 24">
							<circle
						...
						<p className="mt-4 text-xl text-white font-bold tracking-wide">Logging you in...</p>
					</div>
				</div>
			</main>
		</div>
...
export default observer(TokenLogin)
