async function createMagicToken(uuid) {
	const response = await fetch(`https://vapi.veltpvp.com/debug/api/magicToken/create/${uuid}`)
...
export default async function handler(req, res) {
	...
	function handleError(error) {
		console.error(`An error ocurred while generating a magic token for ${uuid}:`, error)
